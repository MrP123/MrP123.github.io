...
var game = {
    ...
    loadLevels : function () {
        ...
        logger.log('Level werden geladen...');
        ...
        script.onload = function () {
            ...
            ui.prestart();
            logger.log('Level wurden erfolgreich geladen. Bitte fortfahren');
        };
...
var ui = {
    ...
    restartLevel : function () {
        if (this.state === 'run' || this.state === 'level') {
            ...
            if (idiotCounter < 10){
                logger.log("Hie gibt es nichts das neu gestartet werden kann!");
            }else if (idiotCounter < 20){
                logger.log("Sebastian, bist du wirklich so dumm?")
            }else{
                logger.log("Es gibt hier keine weiteren Easer Eggs.")
            }
            idiotCounter++;
        }
    },
